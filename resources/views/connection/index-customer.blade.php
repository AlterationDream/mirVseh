...
@section('title', __("app.customers_database") )
@section('style')
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{__('app.customers_database')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <h4>{{__('app.customers_database')}}</h4>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <a href="/connections/customer/create" class="btn btn-primary mb-2">{{__('app.new_customer')}}</a>
                                    </div>
                                    <div class="table_show mb-3">
                                        ...
                                        <label for="contract_date">{{__('app.contract_date')}}</label>
                                        ...
                                        <div class="table-responsive no-padding">
                                            <table id="dataTable" class="table table-hover table-striped table-borderless">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="contract_date_col">{{__('app.contract_date')}}</th>
                                                    <th class="region_col">Регион</th>
                                                    <th class="address_col">{{__('app.address')}}</th>
                                                ...
                                                @foreach ($connections as $customer)
                                                    <tr>
                                                        <td class="fullname_col">{{ $customer->fullname }}</td>
                                                        <td class="email_col">{{ $customer->email }}</td>
                                                        <td class="phone_col">{{ $customer->phone }}</td>
                                                        <td class="position_col">{{ $customer->position }}</td>
                                                        <td class="age_col">{{ $customer->age }}</td>
                                                        <td class="contract_date_col">{{ $customer->contract_date }}</td>
                                                        <td class="region_col">{{ $customer->region }}</td>
                                                        <td class="address_col">{{ $customer->address }}</td>
                                                        <td class="description_col">{{ $customer->description }}</td>
                                                        <td class="doc_col"> @if($customer->doc != '') <a href="{{ $customer->doc }}" target="_blank">Открыть</a> @else Нет @endif </td>
                                                        <td class="action_col">
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    <div class="mx-1">
                                                                        <a href="/connections/customer/{{$customer->id}}/edit"><button class="btn btn-info" data-toggle="tooltip"  data-placement="bottom" title="{{__('app.edit')}}"/><i class="fa fa-edit text-white"></i></button></a>
                                                                    </div>
                                                                    <div class="mx-1">
                                                                        <a href="/connections/customer/{{$customer->id}}/remove"><button class="btn btn-info" data-toggle="tooltip"  data-placement="bottom" title="{{__('app.remove_customer')}}"/><i class="fa fa-remove text-white"></i></button></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
