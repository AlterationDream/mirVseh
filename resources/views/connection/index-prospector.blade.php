...
@section('title', __("app.prospectors_database") )
@section('style')
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{__('app.prospectors_database')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <a href="/connections/prospector/create" class="btn btn-primary mb-2">{{__('app.new_prospector')}}</a>
                                    </div>
                                        ...
                                        <div class="table-responsive no-padding">
                                            <table id="dataTable" class="table table-hover table-striped table-borderless">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="region_col">{{__('app.region')}}</th>
                                                    <th class="position_col">Должность</th>
                                                ...
                                                @foreach ($connections as $prospector)
                                                    <tr>
                                                        <td class="fullname_col">{{ $prospector->fullname }}</td>
                                                        <td class="email_col">{{ $prospector->email }}</td>
                                                        <td class="phone_col">{{ $prospector->phone }}</td>
                                                        <td class="experience_col">{{ $prospector->experience }}</td>
                                                        <td class="age_col">{{ $prospector->age }}</td>
                                                        <td class="price_col">{{ $prospector->price }}</td>
                                                        <td class="region_col">{{ $prospector->region }}</td>
                                                        <td class="position_col">{{ $prospector->position }}</td>
                                                        <td class="description_col">{{ $prospector->description }}</td>
                                                        <td class="doc_col"> @if($prospector->doc != '') <a href="{{ $prospector->doc }}" target="_blank">Открыть</a> @else Нет резюме @endif </td>
                                                        <td class="action_col">
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    <div class="mx-1">
                                                                        <a href="/connections/prospector/{{$prospector->id}}/edit"><button class="btn btn-info" data-toggle="tooltip"  data-placement="bottom" title="{{__('app.edit')}}"/><i class="fa fa-edit text-white"></i></button></a>
                                                                    </div>
                                                                    <div class="mx-1">
                                                                        <a href="/connections/prospector/{{$prospector->id}}/remove"><button class="btn btn-info" data-toggle="tooltip"  data-placement="bottom" title="{{__('app.remove_prospector')}}"/><i class="fa fa-remove text-white"></i></button></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
