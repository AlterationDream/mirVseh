                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <input id="status_toggle" type="checkbox"   name="stripe_status" data-toggle="toggle" data-width="100" data-on="Вкл" data-size="sm" data-off="Выкл" data-onstyle="success" data-offstyle="danger"  {{ setting('stripe_status')? 'checked':'unchecked' }}>
                                  </div>
                                </div>
                              ...
                              <div class="col-md-12">
                                <div class="form-group row mb-4">
                                  <div class="col-md-8">
                                    ...
                                    {{!setting('2fa')? 'Активировать': 'Деактивировать'}} {{__('app.app_two_factor_auth_state')}}
                                  </div>
                                  <div class="col-md-4">
                                    <input id="status_toggle" type="checkbox"   name="two_factor_auth" data-toggle="toggle" data-width="100" data-on="Вкл" data-size="sm" data-off="Выкл" data-onstyle="success" data-offstyle="danger"  {{ setting('2fa')? 'checked':'unchecked' }}>
                                  </div>
              									</div>
                                <div class="form-group row mb-4">
                                  <div class="col-md-8">
                                    <strong class="d-block">{{__('app.app_captcha')}}</strong>
                                    {{!setting('captcha')? 'Активировать': 'Деактивировать'}} {{__('app.app_captcha_state')}}
                                  </div>
                                  <div class="col-md-4">
                                    <input id="status_toggle" type="checkbox"   name="captcha" data-toggle="toggle" data-width="100" data-on="Вкл" data-size="sm" data-off="Выкл" data-onstyle="success" data-offstyle="danger"  {{ setting('captcha')? 'checked':'unchecked' }}>
                                  </div>
              									</div>
                                <div class="form-group row">
                                  <div class="col-md-8">
                                    <strong class="d-block">{{__('app.app_email_verification')}}</strong>
                                    {{!setting('email_verification')? 'Активировать': 'Деактивировать'}} {{__('app.app_email_verification_state')}}
                                  </div>
                                  <div class="col-md-4">
                                    <input id="status_toggle" type="checkbox"   name="email_verification" data-toggle="toggle" data-width="100" data-on="Вкл" data-size="sm" data-off="Выкл" data-onstyle="success" data-offstyle="danger"  {{ setting('email_verification')? 'checked':'unchecked' }}>
                                  </div>
                                </div>
                              </div>
