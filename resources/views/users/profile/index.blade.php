                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <button type="button" id="rotate-image"
                                                        class="btn btn-info col-sm-12 mb-1">{{__('app.rotate_image')}}</button>
                                ...
                                <div class="tab-content mt-3 mx-0">
                                    <div class="tab-pane active" id="account-details" role="tabpanel"
                                        ...
                                        <form class="form-horizontal" method="POST"
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-6 mt-1">
                                                    ...
                                                    <select class="form-control" name="status" disabled>
                                                        ...
                                                        <option
                                                            value="active" {{($user->status == 'banned')? 'SELECTED':''}}>
                                                            Заблокирован
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-6 mt-1">
                                                    ...
                                                    <input type="text" name="country" value="{{ $user->country }}"
                                                           class="form-control" placeholder="{{__('app.country')}}">
                                                ...
                                                <div class="col-sm-6 mt-1">
                                                    ...
                                                    <input type="text" name="address" class="form-control"
                                                           value="{{$user->address}}" id="address" placeholder="Адрес">
                                            ...
                                            <div class="col-md-8 mx-auto">
                                                <button type="submit"
                                                        class="btn btn-primary col-sm-12">{{__('app.update_account')}}</button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="tab-pane" id="login-details" role="tabpanel"
                                        ...
                                        <form class="form-horizontal" method="POST"
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-6 my-1">
                                                    ...
                                                    <input type="password" name="password" value=""
                                                           placeholder="{{__('app.leave_blank')}}" class="form-control"
                                                           autocomplete="off">
                                                ...
                                                <div class="col-md-6 my-1">
                                                    <div><label
                                                            class="label-block">{{__('app.confirm_password')}}</label>
                                                    </div>
                                            ...
                                            <div class="col-md-8 mx-auto">
                                                <button type="submit"
                                                        class="btn btn-primary col-sm-12">{{__('app.update_login')}}</button>
                                            </div>
                                        </form>
                                    </div>
                                    @if(setting('2fa'))
                                        <div class="tab-pane" id="tfa-settings" role="tabpanel"
                                            ...
                                            @if(empty(auth()->user()->google2fa))
                                                <!--=============Generate QRCode for Google 2FA Authentication=============-->
                                                    <div class="row p-0">
                                                        ...
                                                        <div class="col-md-12">
                                                            <form class="" action="{{route('activate-2fa')}}"
                                                                  method="post">
                                                                @csrf
                                                                <button
                                                                    class="btn btn-primary col-md-6">{{__('app.activate_2fa')}}</button>
                                                                <a class="btn btn-secondary col-md-5"
                                                                   data-toggle="collapse" href="#collapseExample"
                                                                   role="button" aria-expanded="false"
                                                                   aria-controls="collapseExample">{{__('app.setup_instruction')}}</a>
                                                            </form>
                                                        </div>
                                                        <div class="col-md-12 mt-3 collapse" id="collapseExample">
                                                            ...
                                                            <div class="mt-4">
                                                                ...
                                                                <p><label>{{__('app.step_1')}}
                                                                        :</label> {{__('app.download')}}
                                                                    <strong>{{__('app.google_auth')}}</strong> {{__('app.app_for_andriod_or_ios')}}
                                                                </p>
                                                                <p class="text-center">
                                                                    <a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=en"
                                                                       target="_blank"
                                                                       class="btn btn-success">{{__('app.download_for_android')}}
                                                                        <i class="fa fa-android fa-2x ml-2"></i></a>
                                                                    <a href="https://apps.apple.com/us/app/google-authenticator/id388497605"
                                                                       target="_blank"
                                                                       class="btn btn-dark ml-2">{{__('app.download_for_iPhones')}}
                                                                        <i class="fa fa-apple fa-2x ml-2"></i></a></p>
                                                                <p><label>{{__('app.step_2')}}
                                                                        :</label> {{__('app.click_on_generate_secret')}}
                                                                </p>
                                                                <p><label>{{__('app.step_3')}}
                                                                        :</label> {{__('app.open_the')}}
                                                                    <strong>{{__('app.google_auth')}}</strong> {{__('app.and_click_on')}}
                                                                    <strong>{{__('app.begin')}}</strong> {{__('app.on_the_mobile_app')}}
                                                                </p>
                                                                <p><label>{{__('app.step_4')}}
                                                                        :</label> {{__('app.after_which_click_on')}}
                                                                    <strong>{{__('app.scan_a_QRcode')}}</strong></p>
                                                                <p><label>{{__('app.step_5')}}
                                                                        :</label> {{__('app.then_scan_the_barcode_on')}}
                                                                </p>
                                                                <p><label>{{__('app.step_6')}}
                                                                        :</label> {{__('app.enter_the_verification_code')}}
                                                                </p>
                                                                <hr>
                                                                <p><label>{{__('app.note')}}
                                                                        :</label> {{__('app.to_diasable_2fa_enter')}}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            @elseif(!auth()->user()->google2fa->google2fa_enable)
                                                <!--=============Enable Google 2FA Authentication=============-->
                                                    <form class="form-horizontal" method="POST"
                                                          action="{{route('enable-2fa')}}">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-md-12"><p>
                                                                    <strong>{{__('app.scan_the_qrcode_with')}}
                                                                        <dfn>{{__('app.google_auth')}}</dfn> {{__('app.and_enter_the_generated_code_below')}}
                                                                    </strong></p></div>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <label for="address"
                                                                       class="control-label">{{__('app.verification_code')}}</label>
                                                                <input type="text" name="code" class="form-control"
                                                                       id="code"
                                                                       placeholder="{{__('app.enter_verification_code')}}">
                                                                @if ($errors->has('code'))
                                                                    <span class="invalid-feedback" role="alert">
                                              <strong>{{ $errors->first('code') }}</strong>
                                                        ...
                                                        <div class="col-md-8 mx-auto m-2">
                                                            <button type="submit"
                                                                    class="btn btn-primary col-sm-12">{{__('app.enable_2fa')}}</button>
                                                        </div>
                                                    </form>
                                                    <!--=============Enable Google 2FA Authentication=============-->
                                            @elseif(auth()->user()->google2fa->google2fa_enable)
                                                <!--=============Disable Google 2FA Authentication=============-->
                                                  ...
                                                  <strong>{{ $errors->first('code') }}</strong>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <label for="address"
                                                                       class="control-label">{{__('app.current_password')}}</label>
                                                    ...
                                                    <strong>{{ $error('password')}}</strong>
                                                        ...
                                                        <div class="col-md-8 mx-auto m-2">
                                                            <button type="submit"
                                                                    class="btn btn-danger col-sm-12">{{__('app.disable_2fa')}}</button>
                                                        </div>
                                                    </form>
                                                    <!--=============Disable Google 2FA Authentication=============-->
                                                @endif
