                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <span class="mt-2 mb-0 d-block">
                                            <p><b>Роль:</b>
                                                {{($user_role)? ucfirst($user_role->name): 'Нет роли'}}
                                            </p>
                                        </span>
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item shadow mb-3 mr-2">
                                        <a class="nav-link" id="activiylog-details-tab" data-toggle="tab"
                                           ...
                                           aria-selected="false">{{__('app.activity_logs')}}</a>
                                    </li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content mt-3">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-6 mt-1">
                                                    ...
                                                    <select name="role" class="form-control form-control-inline-block">
                                                        @foreach($roles as $role)
                                                            <option
                                                                value="{{$role->name}}" {{((($user_role)? $user_role->name:'') == $role->name)? 'selected':''}}>{{str_replace('-', ' ', $role->name)}}</option>
                                                        @endforeach
                                                        @if ($errors->has('role'))
                                                ...
                                                <div class="col-md-6 mt-1">
                                                    ...
                                                    <select name="status"
                                                        ...
                                                        <option
                                                            value="banned" {{($user->status == 'banned')? 'selected':''}}>
                                                            Заблокирован
                                                        </option>
                                                ...
                                                <div class="col-md-6 mb-1 mt-1">
                                                    ...
                                                    <input type="text" name="fullname" value="{{ $user->fullname }}"
                                                           class="form-control" placeholder="{{__('app.fullname')}}">
                                                ...
                                                <div id="birthday" class="col-sm-6 mb-1 mt-1">
                                                    ...
                                                    <input type="text" name="birthday" value="{{$user->birthday}}"
                                                           placeholder="{{__('app.birthday')}}" class="form-control">
                                                    @error('birthday')
                                                ...
                                                <div class="col-md-6 mt-1">
                                                    ...
                                                    <input type="text" name="phone" value="{{$user->phone}}"
                                                           class="form-control" placeholder="{{__('app.phone')}}">
                                                    @if ($errors->has('phone'))
                                                        <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="tab-pane" id="login-details" role="tabpanel"
                                        ...
                                        <form class="form-horizontal" method="POST"
                                              action="{{route('user-login',$user->id)}}">
                                            @csrf
                                            <div class="row form-group">
                                                <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a href="/user/{{$user->id}}/activity-log/"
                                                   class="btn btn-outline-secondary pull-right">{{__('app.view_all')}}</a>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="table-responsive no-padding">
                                                    <table class="table table-hover table-striped table-borderless">
                                                        ...
                                                        @else
                                                            <tr>
                                                                <td colspan="2"><i><h5
                                                                            class="text-muted text-center">{{__('app.no_record')}}</h5>
                                                                    </i></td>
                                                            </tr>
                                                        @endif
                                                        </tbody>
