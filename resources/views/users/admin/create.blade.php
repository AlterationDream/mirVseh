                                            ...
                                            <div class="form-row mb-2">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="fullname" value="{{old('fullname')}}"
                                                           placeholder="{{__('app.fullname')}}" class="form-control"
                                                           id="fullname">
                                                    @error('fullname')
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select name="role" class="form-control">
                                                        @foreach($roles as $role)
                                                            <option
                                                                value="{{$role->name}}">{{str_replace('-', ' ', ucfirst($role->name))}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-row mb-2">
                                                ...
                                                <div class="col-sm-6">
                                                    <label for="username"
                                                           class="control-label">{{__('app.username')}}</label>
                                            ...
                                            <div class="form-row mb-2">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="password" name="password" class="form-control"
                                                           id="password" placeholder="{{__('app.password')}}">
                                                ...
                                                <div class="col-sm-6">
                                                    <label for="password_confirmation"
                                                           class="control-label">{{__('app.confirm_password')}}</label>
                                    ...
                                    <div class="col-md-8 mx-auto mt-4">
                                        <button type="submit"
                                                class="btn btn-primary col-md-12">{{__('app.create_user')}}</button>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </div>
