                                        ...
                                        <div class="folder-tree">
                                            ...
                                            <!--table id="dataTableTree" class="table table-hover table-striped table-borderless">
                                                ...
                                                @foreach ($folders as $folder)
                                                    <div class="list-item level-0<?php if ($folder->isArchived == '1'): ?> archived<?php endif;?>" id="{{$folder->id}}" slug="{{$folder->slug}}">
                                                        <div class="title">
                                                            <div class="tree-branches"></div>
                                                            <img src="/uploads/avatar/folder.png" style="max-height: 32px" onclick="openClose(this.parentElement.parentElement, 'folder', {{$folder->id}}, '/')"><span onclick="openClose(this.parentElement.parentElement, {{$folder->id}}, '/')">{{ $folder->title }}</span>
                                                        </div>
                                                        ...
                                                        <div class="date" data-sort="{{ $folder->created_at->format('Y-m-d H:i:s') }}">{{ $folder->created_at->format('d.m.Y в H:i') }}</div>
