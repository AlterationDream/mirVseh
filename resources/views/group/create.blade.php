                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{__('app.new_group')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12 mx-auto">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{__('app.new_group')}}</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <article class="">
                                    <form action="/groups/create" method="POST" class="form-horizontal" id="folder-create" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md">
                                                <input type="text" name="title" class="form-control" id="title" placeholder="{{__('app.group_title')}}" value="{{ old('title') }}">
