...
@section('title','Редактирование правил доступа роли')
@section('content')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">{{str_replace('-', ' ', ucfirst($role->name))}}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                              	...
                              	<div class="icheck-primary">
                                   ...
                                   >
                  							  <label for="role{{$allpermission->id}}">
                  								          {{str_replace('-', ' ', ucfirst($allpermission->name))}}
                  							  </label>
                  							</div>
                              @endforeach
                          </div>
