        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['Операции-с-пользователями', 'Просмотр-истории-активности'])): ?>
                                <div class="card-header">
                                    ...
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Просмотр-истории-активности')): ?>
                                    <div class="mx-1 pull-right">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mt-1">
                                        ...
                                        <p><?php echo e(str_replace('-', ' ', $user_role->name)); ?></p>
                                    </div>
                                    <div class="col-md-6 mt-1">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/moi.mirvseh.ru/resources/views/users/admin/show.blade.php ENDPATH**/ ?>