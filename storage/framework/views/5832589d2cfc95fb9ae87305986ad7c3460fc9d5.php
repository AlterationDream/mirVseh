            ...
            <div class="row mt-80 align-items-center">
                <div class="col-lg-6">
                    <div class="about-text style2 pl-0 pr-60">
                        ...
                        <p class="m-0">Donec mollis purus auctor egestas vestibulum. Ut ut pellentesque quam. Curabitur sed tempor augue. Etiam finibus lectus tempor nisi aliquet, at ultricies felis mollis. Aenean porta metus et sapien posuere, eget efficitur elit dapibus. Duis placerat vitae odio at cursus. Phasellus tempus a dui quis lacinia. Ut eget tellus urna. Pellentesque tincidunt tortor quis leo tincidunt lobortis. Pellentesque ac velit congue, scelerisque velit at, dapibus enim. </p>
                    </div><!--about-text end-->
                </div>
                <div class="col-lg-6">
                    <div class="abt-img overlay">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/moi.mirvseh.ru/resources/views/frontend/about.blade.php ENDPATH**/ ?>