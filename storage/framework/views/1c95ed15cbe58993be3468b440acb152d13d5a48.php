...
<head>
  ...
  <title><?php echo e(_('Reset')); ?> - <?php echo setting('app_name'); ?></title>
  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <h4 class="text-center"><?php echo e(__('app.forgot_password')); ?></h4>
                    ...
                    <form method="POST" action="<?php echo e(route('password.update')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-12 col-form-label"><?php echo e(__('app.email_address')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-12 col-form-label"><?php echo e(__('app.password')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-12 col-form-label"><?php echo e(__('app.confirm_password')); ?></label>
...
<?php /**PATH C:\Soft\OpenServer\domains\MirVseh\resources\views/auth/passwords/reset.blade.php ENDPATH**/ ?>