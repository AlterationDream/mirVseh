...
<div class="wrapper">
  ...
  <footer class="main-footer text-center">
    <strong>Copyright &copy; <?php echo e(date('Y')); ?> <a href="<?php echo e(env('APP_URL')); ?>"><?php echo e(setting('app_name')); ?></a>.</strong> All rights
    reserved.
  </footer>
</div>
<!-- ./wrapper -->
...
<?php /**PATH C:\Users\DORO\Documents\My Project\LaraSwift\PACKAGE FOR SALE\LaraSwift v8\Laraswift-Payment-Envato\resources\views/layouts/template.blade.php ENDPATH**/ ?>