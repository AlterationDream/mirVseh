                                                ...
                                                <div class="col-md-6 mt-1">
                                                    ...
                                                    <select name="role" class="form-control form-control-inline-block">
                                                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                value="<?php echo e($role->name); ?>" <?php echo e(((($user_role)? $user_role->name:'') == $role->name)? 'selected':''); ?>><?php echo e($role->name); ?></option>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Soft\OpenServer\domains\MirVseh\resources\views/users/admin/edit.blade.php ENDPATH**/ ?>