<?php $__env->startSection('title','Записи об активности'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3> <?php echo e(($user->firstname)? $user->firstname:$user->email); ?> - История активности</h3>
          </div>
          <div class="col-sm-6">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/moi.mirvseh.ru/resources/views/users/admin/userLog.blade.php ENDPATH**/ ?>