                                    ...
                                    <form action="/cases/<?php echo e($businessCase->slug); ?>/<?php echo e($dialog->id); ?>/edit" method="POST" class="form-horizontal" id="business-case-create">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md">
                                                ...
                                                <label id="user-select-label" for="users" class="mt-2 ml-1" <?php if(!$dialog->tetatet): ?> style="display:none" <?php endif; ?> ><?php echo e(__('app.dialog_participants')); ?>:</label>
                                                <div id="user-select" <?php if(!$dialog->tetatet): ?> style="display:none" <?php endif; ?> ></div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/moi.mirvseh.ru/resources/views/dialog/edit.blade.php ENDPATH**/ ?>