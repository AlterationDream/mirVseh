<?php $__env->startSection('title','Редактирование правил доступа роли'); ?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo e(str_replace('-', ' ', ucfirst($role->name))); ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                              	...
                              	<div class="icheck-primary">
                                   ...
                                   >
                  							  <label for="role<?php echo e($allpermission->id); ?>">
                  								          <?php echo e(str_replace('-', ' ', ucfirst($allpermission->name))); ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/moi.mirvseh.ru/resources/views/roles/show.blade.php ENDPATH**/ ?>