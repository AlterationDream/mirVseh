<?php $__env->startSection('title','Роли пользователей'); ?>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo e(str_replace('-', ' ', $role->name)); ?></td>
                    <td data-sort="<?php echo e($role->created_at); ?>"><?php echo e($role->created_at->format('d.m.Y в H:i')); ?></td>
                    <td data-sort="<?php echo e($role->updated_at); ?>"><?php echo e($role->updated_at->format('d.m.Y в H:i')); ?></td>
                    <td>
                      <div class="col-md-12">
                        <div class="row">
                          <div class="mx-1">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/moi.mirvseh.ru/resources/views/roles/index.blade.php ENDPATH**/ ?>