                    ...
                    <div class="contact_info">
                        <ul>
                            <li>
                                ...
                                <div class="ccn-info">
                                    <p>340 Woodland Dr. Southaven, MS 38671</p>
                                </div>
                            </li>
                            <li>
                                <span>
                                ...
                                <div class="ccn-info">
                                    <p><span>Mon-Sat: </span> 8 am til 5 pm</p>
                ...
                <div class="col-lg-8">
                    <div class="cnst-form">
                        <div class="section-title">
                            <h2 class="h-title dark-clr mw-100">Receive consultation</h2>
                        ...
                        <div class="consulation-form">
                            <form id="contact-form" method="post" action="#">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="form-group">
                                            <input type="number" name="phone" class="form-control email" placeholder="Phone*">
                                        </div><!--form-group end-->
                                    </div>
                                    <div class="col-lg-10">
                                        <div class="form-group">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/moi.mirvseh.ru/resources/views/frontend/contact.blade.php ENDPATH**/ ?>