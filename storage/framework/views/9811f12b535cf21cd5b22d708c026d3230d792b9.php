...
<?php $__env->startSection('title','CRUD-Builder'); ?>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1><?php echo e(__('app.crud_builder')); ?></h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/"><?php echo e(__('app.home')); ?></a></li>
            <li class="breadcrumb-item active"><?php echo e(__('app.crud_builder')); ?></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
                  ...
                  <section class="content">
                      <div class="card col-lg-12 p-0">
                          <div class="card-header">
                              <h1 class="card-title"><?php echo e(__('app.crud_builder')); ?></h1>
                          </div>
                          <div class="card-body">
                              <form id="form">
                                  ...
                                  <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="txtModelName"><?php echo e(__('app.model_name')); ?><span class="required" data-toggle="tooltip" data-placement="top" title="Tooltip on top">*</span></label>
                                            <input type="text" class="form-control" required id="txtModelName" placeholder="<?php echo e(__('app.enter_model_name')); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="drdCommandType"><?php echo e(__('app.command_type')); ?></label>
                                            <select id="drdCommandType" class="form-control form-control-md width-100">
                                                <option value="infyom:scaffold"><?php echo e(__('app.scaffold_generator')); ?></option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="txtCustomTblName"><?php echo e(__('app.custom_table_name')); ?></label>
                                            <input type="text" class="form-control" id="txtCustomTblName" placeholder="<?php echo e(__('app.enter_table_name')); ?>">
                                        </div>
                                        <div class="form-group col-md-5">
                                          <label for="txtModelName"><?php echo e(__('app.options')); ?></label>
                                            <div class="form-inline form-group transparent-border">
                                                <div class="checkbox chk-align ml-3">
                                                    <label>
                                                        <input type="checkbox" class="flat-red " id="chkDelete"><span
                                                            class="chk-label-margin mx-1">  <?php echo e(__('app.soft_delete')); ?> </span>
                                                    </label>
                                                </div>
                                                <div class="checkbox chk-align ml-3" id="chDataTable">
                                                    <label>
                                                        <input type="checkbox" class="flat-red " id="chkDataTable" checked>
                                                        <span class="chk-label-margin mx-1"><?php echo e(__('app.databases')); ?></span>
                                                    </label>
                                                </div>
                                                <div class="checkbox chk-align" id="chForceMigrate">
                                                    <label>
                                                        ...
                                                        <span class="chk-label-margin"><?php echo e(__('app.migrate')); ?></span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-4">
                                          <label for="txtPrefix"><?php echo e(__('app.prefix')); ?></label>
                                          <input type="text" class="form-control" id="txtPrefix" placeholder="Enter prefix">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="txtPaginate"><?php echo e(__('app.paginate')); ?></label>
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="form-control transparent-border padding-left-0">
                                                <label><?php echo e(__('app.fields')); ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive col-md-12">
                                            <table class="table table-striped table-bordered" id="table">
                                                ...
                                                <tr>
                                                    <th><?php echo e(__('app.field_name')); ?></th>
                                                    <th><?php echo e(__('app.db_type')); ?></th>
                                                    <th><?php echo e(__('app.validation')); ?></th>
                                                    <th><?php echo e(__('app.html_type')); ?></th>
                                                    <th class="px-width-68"><?php echo e(__('app.primary')); ?></th>
                                                    <th class="px-width-80"><?php echo e(__('app.is_foreign')); ?></th>
                                                    <th class="px-width-87"><?php echo e(__('app.searchable')); ?></th>
                                                    <th class="px-width-63"><?php echo e(__('app.fillable')); ?></th>
                                                    <th class="px-width-65"><?php echo e(__('app.in_form')); ?></th>
                                                    <th class="px-width-67"><?php echo e(__('app.in_index')); ?></th>
                                                    <th></th>
                                                </tr>
                                                </thead>
                                        ...
                                        <div class="form-inline col-md-6 mt-2">
                                            <div class="form-group mx-1 col-md-12 transparent-border">
                                                <button type="button" class="btn btn-success btn-green col-md-4" id="btnAdd"> <?php echo e(__('app.add_field')); ?>
                                  ...
                                  <div class="form-inline col-md-12 mt-5">
                                          <div class="form-group col-md-6 transparent-border padding-left-10">
                                            <button type="submit" class="btn  btn-primary btn-blue col-md-12" id="btnGenerate"><?php echo e(__('app.generate')); ?>

                                            </button>
                                          </div>
                                          <div class="form-group col-md-6 transparent-border padding-left-10">
                                              <button type="button" class="btn btn-light col-md-12 " id="btnReset" data-toggle="modal"
                                              data-target="#confirm-delete"><?php echo e(__('app.reset')); ?>
                                      ...
                                      <div class="modal-dialog">
                                          <div class="modal-content">
                                              ...
                                              <div class="modal-header">
                                                  ...
                                                  <h4 class="modal-title" id="myModalLabel"><?php echo e(__('app.confirm_reset')); ?></h4>
                                              </div>

                                              <div class="modal-body">
                                                  <p><?php echo e(__('app.confirm_reset_message')); ?></p>

                                                  <p class="debug-url"></p>
                                              </div>

                                              <div class="modal-footer">
                                                  <button type="button" class="btn  btn-default" data-dismiss="modal"><?php echo e(__('app.no')); ?>

                                                  </button>
                                                  <a id="btnModelReset" class="btn  btn-danger btn-ok" data-dismiss="modal"><?php echo e(__('app.yes')); ?></a>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
              ...
              <div class="col-md-12">
                  <section class="content">
                      ...
                      <div class="card card-primary col-lg-12 p-0">
                          <div class="card-header">
                              <h1 class="card-title"><?php echo e(__('app.rollback')); ?></h1>
                          </div>
                          <div class="card-body">
                              <form id="rollbackForm">
                                  ...
                                  <div class="row">
                                      <div class="form-group col-md-4">
                                          <label for="txtRBModelName"><?php echo e(__('app.model_name')); ?><span class="required">*</span></label>
                                          <input type="text" class="form-control" required id="txtRBModelName" placeholder="<?php echo e(__('app.enter_model_name')); ?>">
                                      </div>
                                      <div class="form-group col-md-4">
                                          <label for="drdRBCommandType"><?php echo e(__('app.command_type')); ?></label>
                                          <select id="drdRBCommandType" class="form-control width-100">
                                              <option value="scaffold" selected><?php echo e(__('app.scaffold_generator')); ?></option>
                                          </select>
                                      </div>
                                      <div class="form-group col-md-4">
                                          <label for="txtRBPrefix"><?php echo e(__('app.prefix')); ?></label>
                                          <input type="text" class="form-control" id="txtRBPrefix" placeholder="<?php echo e(__('app.enter_prefix')); ?>">
                                      </div>
                                      <div class="form-inline col-md-12 text-right padding-15">
                                      <div class="form-group transparent-border padding-left-10">
                                          <button type="submit" class="btn  btn-primary btn-blue" id="btnRollback"><?php echo e(__('app.rollback')); ?>
...
var fieldIdArr = [];
    ...
    var modelUrl = "<?php echo e(URL::to('/model-check')); ?>";
    ...
    $(document).ready(function () {
        ...
        var commonComponent = $(htmlStr).filter("tr").load('<?php echo e(route('field-template')); ?>');
        ...
        $("#form").on("submit", function () {
            ...
            $('#btnGenerate').prop('disabled', true);
            $.ajax({
                url: '<?php echo e(route('generator-builder/generate')); ?>',
               // type: "POST",
                method: "POST",
                dataType: 'json',
                contentType: 'application/json',
        ...
        $('#rollbackForm').on("submit", function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route('generator-builder/rollback')); ?>',
                method: "POST",
                dataType: 'json',
                contentType: 'application/json',
                data: JSON.stringify(data),
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Soft\OpenServer\domains\MirVseh\resources\views/crud-view/builder.blade.php ENDPATH**/ ?>