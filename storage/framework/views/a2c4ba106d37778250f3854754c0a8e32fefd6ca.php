<?php $__env->startSection('title','История активности'); ?>
                 ...
                 <div class="card-body">
                   <div class="row">
                     <div class="col-md-12 mb-3">
                       <h3 class="pull-right"><?php echo e(__('app.activity_logs')); ?></h3>
                     </div>
                     <div class="col-md-12">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/moi.mirvseh.ru/resources/views/activitylog/userLog.blade.php ENDPATH**/ ?>