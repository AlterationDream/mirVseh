                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                              <div class="table-responsive no-padding">
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo e(date('d-m-Y h:i',$plan['start_date'])); ?></td>
                                    </tr>
                                    <tr>
                                      <td class="ml-5"><?php echo e(__('app.plan_expiring_date')); ?></td>
                                      <td><?php echo e(date('d-m-Y h:i',$plan['end_date'])); ?></td>
                                    </tr>
                    							</table>
                            </div>
                        </div>
                        <div class="col-md-12 mx-auto mt-3">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <button type="button" class="btn btn-danger col-md-12 text-white" data-toggle="modal" data-target="#cancelSub"><?php echo e(__('app.cancel_subscription')); ?></button>
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    <div class="modal-body text-center">
                                      ...
                                      <a href="/subscription-cancel/<?php echo e($plan['subscriptionId']); ?>" class="btn btn-danger col-md-6 pull-right text-white"><?php echo e(__('app.cancel_subscription')); ?></a>
                                    </div>
                                  </div>
                                </div>
                              </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DORO\Documents\My Project\LaraSwift\PACKAGE FOR SALE\LaraSwift v8\Laraswift-Payment-Envato\resources\views/subscription/active.blade.php ENDPATH**/ ?>