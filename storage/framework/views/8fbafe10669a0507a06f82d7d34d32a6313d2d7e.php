                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <input id="status_toggle" type="checkbox"   name="stripe_status" data-toggle="toggle" data-width="100" data-on="Enabled" data-size="sm" data-off="Disabled" data-onstyle="success" data-offstyle="danger"  <?php echo e(setting('stripe_status')? 'checked':'unchecked'); ?>>
                                  </div>
                                </div>
                              ...
                              <div class="col-md-12">
                                <div class="form-group row mb-4">
                                  <div class="col-md-8">
                                    ...
                                    <?php echo e(!setting('2fa')? 'Activate': 'Deactivate'); ?> <?php echo e(__('app.app_two_factor_auth_state')); ?>

                                  </div>
                                  <div class="col-md-4">
                                    <input id="status_toggle" type="checkbox"   name="two_factor_auth" data-toggle="toggle" data-width="100" data-on="Enabled" data-size="sm" data-off="Disabled" data-onstyle="success" data-offstyle="danger"  <?php echo e(setting('2fa')? 'checked':'unchecked'); ?>>
                                  </div>
              									</div>
                                <div class="form-group row mb-4">
                                  <div class="col-md-8">
                                    <strong class="d-block"><?php echo e(__('app.app_captcha')); ?></strong>
                                    <?php echo e(!setting('captcha')? 'Activate': 'Deactivate'); ?> <?php echo e(__('app.app_captcha_state')); ?>

                                  </div>
                                  <div class="col-md-4">
                                    <input id="status_toggle" type="checkbox"   name="captcha" data-toggle="toggle" data-width="100" data-on="Enabled" data-size="sm" data-off="Disabled" data-onstyle="success" data-offstyle="danger"  <?php echo e(setting('captcha')? 'checked':'unchecked'); ?>>
                                  </div>
              									</div>
                                <div class="form-group row">
                                  <div class="col-md-8">
                                    <strong class="d-block"><?php echo e(__('app.app_email_verification')); ?></strong>
                                    <?php echo e(!setting('email_verification')? 'Activate': 'Deactivate'); ?> <?php echo e(__('app.app_email_verification_state')); ?>

                                  </div>
                                  <div class="col-md-4">
                                    <input id="status_toggle" type="checkbox"   name="email_verification" data-toggle="toggle" data-width="100" data-on="Enabled" data-size="sm" data-off="Disabled" data-onstyle="success" data-offstyle="danger"  <?php echo e(setting('email_verification')? 'checked':'unchecked'); ?>>
                                  </div>
                                </div>
                              </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DORO\Documents\My Project\LaraSwift\PACKAGE FOR SALE\LaraSwift v8\Laraswift-Payment-Envato\resources\views/settings/index.blade.php ENDPATH**/ ?>
