                                ...
                                <?php if($businessCase->folder && $canViewFolder): ?>
                                    <div class="mx-1 pull-right">
                                        <a href="<?php echo e($businessCase->slug); ?>/folder">
                                            <button class="btn btn-info" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Папка дела">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Soft\OpenServer\domains\MirVseh\resources\views/business-case/show.blade.php ENDPATH**/ ?>