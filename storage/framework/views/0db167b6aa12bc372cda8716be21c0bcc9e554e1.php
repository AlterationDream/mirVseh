                                            ...
                                            <table id="dataTable" class="table table-hover table-striped table-borderless">
                                                ...
                                                <?php $__currentLoopData = $connections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prospector): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td class="doc_col"> <?php if($prospector->doc != ''): ?> <a href="<?php echo e($prospector->doc); ?>" target="_blank">Открыть</a> <?php else: ?> Нет резюме <?php endif; ?> </td>
                                                        <td class="action_col">
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    <div class="mx-1">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Soft\OpenServer\domains\MirVseh\resources\views/connection/index-prospector.blade.php ENDPATH**/ ?>