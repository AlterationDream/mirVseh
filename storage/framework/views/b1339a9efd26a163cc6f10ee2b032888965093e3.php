    ...
    <header>
        <div class="container">
            <div class="header-content d-flex flex-wrap align-items-center">
                ...
                <nav>
                    <ul>
                        <li><a <?php echo e(request()->is('/test')? 'class="active"':''); ?> href="/test/" title="">Главная</a></li>
                        <li><a <?php echo e(request()->is('/test/about')? 'class="active"':''); ?> href="/test/about" title="">О нас</a></li>
                        <li><a <?php echo e(request()->is('/test/services')? 'class="active"':''); ?> href="/test/services" title="">Услуги</a></li>
                        <li><a <?php echo e(request()->is('/test/blog')? 'class="active"':''); ?> href="/test/blog" title="">Новости</a></li>
                        <li><a <?php echo e(request()->is('/test/contact')? 'class="active"':''); ?> href="/test/contact" title="">Контакты</a></li>
                    </ul>
                </nav><!--navigation end-->
...
<?php /**PATH C:\Soft\OpenServer\domains\MirVseh\resources\views/layouts/front.blade.php ENDPATH**/ ?>