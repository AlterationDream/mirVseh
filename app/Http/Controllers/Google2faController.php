...
class Google2faController extends Controller
{
    ...
    */
    public function enable(Request $request)
    {
        ...
        return redirect()->back()->with('fail', 'Код подтверждения не верный');
    }
    ...
    */
    public function disable(Request $request)
    {
        ...
        if (Hash::check($request->password, $user->password)) {
            ...
            return redirect()->back()->with('fail', 'Неверный код подтверждения');
        } else {
            return redirect()->back()->with('fail', 'Неверный пароль! Пожалуйста, попробуйте снова');
        }
    }
