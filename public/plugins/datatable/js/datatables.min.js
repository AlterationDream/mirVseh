...
(function (f) {
    ...
    function Ga(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "Нет результатов для отображения" === b.sEmptyTable && M(a, a, "sZeroRecords", "sEmptyTable");
            !a.sLoadingRecords && d && "Загрузка..." === b.sLoadingRecords && M(a, a,
    ...
    q.defaults = {
        ...
        oLanguage: {
            oAria: {
                sSortAscending: ": активируйте для сортировки колонки по возрастанию",
                sSortDescending: ": активируйте для сортировки колонки по убыванию"
            },
            oPaginate: {
                sFirst: "First", sLast: "Last",
                sNext: "Далее", sPrevious: "Назад"
            },
            sEmptyTable: "Нет результатов для отображения",
            sInfo: "Показано результатов: _TOTAL_ (с _START_ по _END_)",
            sInfoEmpty: "Резултатов не найдено",
            sInfoFiltered: "(отфильтровано результатов: _MAX_)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
